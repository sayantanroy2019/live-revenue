...
const data = [
  { name: 'Food', value: 6400, color: colors[0], label: '6400' },
  { name: 'Alcohol', value: 944, color: colors[1] },
  { name: 'Non-Alcohol', value: 1380, color: colors[2], label: '925' },
  { name: 'Other', value: 4000, color: colors[3], label: '805' },
  { name: 'Other', value: 2700, color: colors[4], label: '508' },
];
...
export const TopSellingCategories = () => {
  return (
    <div className="dark:bg-[#1F1F1F] p-5 rounded-xl xl:min-w-[49%] 2xl:min-w-[49%] lg:min-w-[49%] md:w-full sm:w-full max-sm:w-full flex flex-col items-center text-white  shadow-2xl border-none w-full max-w-md">
      <h2 className="text-lg w-full font-semibold">Top 5 Selling Categories</h2>
